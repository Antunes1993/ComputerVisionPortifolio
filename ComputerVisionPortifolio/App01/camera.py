...
class VideoCamera(object):
    ...
    def faces_detection(self,frame):
        ...
        faces = face_cascade.detectMultiScale(frame, 1.1, 5)  # hist_equalization_detection
        faces_profile_left = profile_face_cascade.detectMultiScale(frame, 1.1, 5)  # hist_equalization_detection
        faces_profile_right = profile_face_cascade.detectMultiScale(cv2.flip(frame,1), 1.1, 5)  # hist_equalization_detection
